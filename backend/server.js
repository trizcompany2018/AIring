            ...
            content: [
              ...
              mediaBlock,
              {
                ...
                text: `
                    ...
                    0. 할인률 계산 - 카탈로그 내 원가 - 할인가(방송가) 작성되어 있는 경우, 상단에 제품별 할인률 작성(원가 대비 00% 할인). 
                    혜택을 최종적으로 받을 수 있는 금액까지 포함하여 정리 (ex. 정상가 100,000원 → 할인가 90,000원(원가 대비 10% 할인) → 최종혜택가 50,000(원가 대비 50% 할인)  )
